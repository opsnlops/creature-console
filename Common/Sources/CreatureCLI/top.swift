...
struct CreatureCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        version: "2.54.1",
        subcommands: [
            Animations.self, Creatures.self, Debug.self, Dialog.self, Exchanges.self,
            Fixtures.self, Metrics.self, Network.self, Playlists.self, Sounds.self, Stages.self,
            Storyboards.self, Util.self, Voice.self, Websocket.self,
        ],

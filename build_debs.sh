...
PRODUCTS=(creature-cli creature-mqtt creature-agent creature-world creature-communicator-gateway creature-house creature-body)
...
build_packages() {
    ...
    docker run --rm \
        ...
        "${image}" bash -c '
            ...
            SWIFT_BUILD_FLAGS_BODY="-c release --product creature-body --static-swift-stdlib" \

...
enum Scried: Hashable, Identifiable {
    ...
    var id: String {
        ...
        case .entity(let page): "entity:\(page.entityID.rawValue)"
        }
    }
    ...
    var title: String {
        ...
        case .entity(let page): page.entityID.rawValue
        }
    }
    ...
    var mundaneJSON: String {
        ...
        do {
            ...
            case .entity(let page): data = try encoder.encode(page)
            }

...
struct AnimationRecordingCoordinator: View {
    ...
    let logger = Logger(subsystem: "io.opsnlops.CreatureConsole", category: "AnimationRecordingCoordinator")
    ...
    private func createNewRecordingSession() {
        ...
        recordingSession = AnimationRecordingSession(
            ...
            availableCreatures: Array(creatureCacheState.creatures.values)
        )
...
struct AnimationRecordingSessionView: View {
    ...
    let logger = Logger(subsystem: "io.opsnlops.CreatureConsole", category: "AnimationRecordingSessionView")
    ...
    var body: some View {
        NavigationView {
            Form {
                ...
                Section("Timing") {
                    TextField("Milliseconds per Frame", 
